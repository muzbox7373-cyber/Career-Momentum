...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-primary text-white hover:bg-blue-900 focus:ring-primary shadow-md",
    secondary: "bg-secondary text-white hover:bg-orange-600 focus:ring-secondary shadow-md",
